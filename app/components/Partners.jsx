    ...
    <>
      ...
      {selectedPartner && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-white max-w-[800px] w-10/12 max-h-svh overflow-y-auto p-5 md:p-8 rounded-lg mx-auto my-4 shadow-lg relative border-b-8 border-primary">
            <button
            ...
            <div className="flex flex-col md:flex-row items-center gap-5 md:gap-8 text-senary">
              ...
              <div className="text-center md:text-start">
                <div className="mb-5 md:bm-8">
                  ...
                  <h3 className="mb-2">{selectedPartner.code}</h3>
